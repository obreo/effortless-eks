...
resource "aws_s3_bucket" "bucket" {
  count = var.integrations.aws_mountpoint_s3_csi_driver.enable && var.integrations.aws_mountpoint_s3_csi_driver.s3_bucket_arn == "" ? 1 : 0
...
resource "aws_vpc_endpoint" "s3" {
  count = var.integrations.aws_mountpoint_s3_csi_driver.enable && var.integrations.aws_mountpoint_s3_csi_driver.create_vpc_endpoint != null ? 1 : 0
  vpc_id       = var.integrations.aws_mountpoint_s3_csi_driver.create_vpc_endpoint.vpc_id
